...
class _OnboardingPage10State extends State<OnboardingPage10>
  ...
  Widget build(BuildContext context) {
    final howToSupport =
        LanguageStrings.getTranslation(widget.language, 'how_to_support_title');
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              OnboardingPageIndicator(currentPage: 9, totalPages: 10),
              ...
              Padding(
                ...
                child: OnboardingNavigationButtons(
                  // Back button goes to page 9
                  onBackPressed: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                        builder: (_) => OnboardingPage9(language: widget.language),
                      ),
                    );
                  },
                  // Next button goes to page 9 (same as page)
                  onNextPressed: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                        builder: (_) => DashboardScreen(language: widget.language),
                      ),
                    );
                  },
                ),
