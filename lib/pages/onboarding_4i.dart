...
class OnboardingPage4i extends StatefulWidget {
  const OnboardingPage4i({super.key});

  @override
  State<OnboardingPage4i> createState() => _OnboardingPage4iState();
}

class _OnboardingPage4iState extends State<OnboardingPage4i>
    with OnboardingAudioMixin<OnboardingPage4i> {
  bool _showText = false;

  /// ✅ Provide audio paths for this page
  @override
  String get englishAudioPath => 'assets/audio/onboarding_5.mp3';
  @override
  String get urduAudioPath => 'assets/audio/onboarding_5_urdu.mp3';
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  OnboardingPageIndicator(currentPage: 4, totalPages: 14),
