...
class _OnboardingPage4State extends State<OnboardingPage4>
    with OnboardingAudioMixin<OnboardingPage4> {
  bool _showText = false;

  /// ✅ Provide audio paths for this page
  @override
  String get englishAudioPath => 'assets/audio/onboarding_4.mp3';
  @override
  String get urduAudioPath => 'assets/audio/onboarding_4_urdu.mp3';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LanguageBloc, LanguageState>(
      builder: (context, state) {
        ...
        final title = LanguageStrings.getTranslation(currentLanguage, 'welcome');
        ...
        return Scaffold(
          body: SafeArea(
            child: Container(
              ...
              color: const Color(0xFFFFF4F4), // background color
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  OnboardingPageIndicator(currentPage: 3, totalPages: 14),
