        ...
        child: Container(
          ...
          child: Column(
            children: [
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    ...
                                    colors: [
                                      Colors.transparent,
                                      const Color(0xFFFFF4F4).withOpacity(0.3),
                                      const Color(0xFFFFF4F4).withOpacity(0.8),
                                    ],
              ...
              const SizedBox(height: 12),
              OnboardingPageIndicator(currentPage: 7, totalPages: 10),
